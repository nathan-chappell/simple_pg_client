import { ArrayType, TBuiltinTypeInfo, isArrayRawType, _getArrayType, builtinTypes } from "./generate_message_impl2";
...
export class TypeInfo {
  ...
  constructor(rawType: string) {
    ...
    if(!_expectedMatch)
      throw new Error(`Couldn't get TypeInfo for ${rawType}`);
