...
/// It is just for extracting information from:
/// https://www.postgresql.org/docs/current/protocol-message-formats.html

let root = document.querySelector(
  "#PROTOCOL-MESSAGE-FORMATS div.variableList dl",
);
let getDeflist = (parent) => {
  const result = [];
  const children = [...parent.children].filter((e) =>
    e.tagName == "DD" || e.tagName == "DT"
  );
