...
Deno.test('write/read CopyOutResponse', async () => {
    const message: NamedTypedValue[] = [{"type":"Char","value":"H","name":"messageType"},{"type":"Int32","value":2562890625,"name":"length"},{"type":"Int8","value":16,"name":"isBinary"},{"sizeType":"Int16","value":[{"type":"Int16","value":43601},{"type":"Int16","value":54560},{"type":"Int16","value":51267}],"name":"formatCodes"}]
