...
import { isParseComplete, parseBackendMessage, ParseComplete } from '../messageFormats.generated.ts'
...
Deno.test('write/read ParseComplete', async () => {
    const message: NamedTypedValue[] = [{"type":"Char","value":"1","name":"messageType"},{"type":"Int32","value":4,"name":"length"}]
    ...
    try {
        ...
        assert(isParseComplete(actualRead as unknown as ParseComplete), `typeGuard: isParseComplete failed`)
