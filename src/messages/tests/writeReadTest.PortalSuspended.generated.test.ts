...
import { isPortalSuspended, parseBackendMessage, PortalSuspended } from '../messageFormats.generated.ts'
...
Deno.test('write/read PortalSuspended', async () => {
    const message: NamedTypedValue[] = [{"type":"Char","value":"s","name":"messageType"},{"type":"Int32","value":4,"name":"length"}]
    ...
    try {
        ...
        assert(isPortalSuspended(actualRead as unknown as PortalSuspended), `typeGuard: isPortalSuspended failed`)
