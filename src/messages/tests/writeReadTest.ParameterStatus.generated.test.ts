...
Deno.test('write/read ParameterStatus', async () => {
    const message: ITypedValue[] = [{"type":"Char","value":"S","name":"messageType"},{"type":"Int32","value":525584577,"name":"length"},{"type":"String","value":"GHIJKLM","name":"name"},{"type":"String","value":"NOPQRST","name":"value"}]
