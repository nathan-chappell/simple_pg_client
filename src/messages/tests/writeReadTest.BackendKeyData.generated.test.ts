...
import { isBackendKeyData, parseBackendMessage, BackendKeyData } from '../messageFormats.generated.ts'
...
Deno.test('write/read BackendKeyData', async () => {
    const message: NamedTypedValue[] = [{"type":"Char","value":"K","name":"messageType"},{"type":"Int32","value":12,"name":"length"},{"type":"Int32","value":0,"name":"pid"},{"type":"Int32","value":1,"name":"key"}]
    ...
    try {
        ...
        assert(isBackendKeyData(actualRead as unknown as BackendKeyData), `typeGuard: isBackendKeyData failed`)
